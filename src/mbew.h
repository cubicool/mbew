...
typedef enum _mbew_status_t {
	MBEW_ENUM(STATUS, VALID, 0x00),
	MBEW_ENUM(STATUS, NULL_CONTEXT, 0x01),
	MBEW_ENUM(STATUS, SOURCE_FILE, 0x02),
	MBEW_ENUM(STATUS, SOURCE_MEMORY, 0x03),
	MBEW_ENUM(STATUS, INIT_IO, 0x04),
	MBEW_ENUM(STATUS, INIT_CODEC, 0x05),
	MBEW_ENUM(STATUS, DURATION, 0x06),
	MBEW_ENUM(STATUS, SCALE, 0x07),
	MBEW_ENUM(STATUS, TRACK_COUNT, 0x08),
